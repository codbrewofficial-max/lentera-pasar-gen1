                ...
                >
                  <div className="space-y-3">
                    <div className="flex items-start justify-between">
                      <div className="h-10 w-10 bg-[#649FF6]/10 text-[#649FF6] rounded-xl flex items-center justify-center">
                    ...
                    <div className="space-y-1">
                      ...
                      {item.price && (
                        <p className="text-xs font-bold text-[#649FF6] font-mono">
          ...
          <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-white rounded-3xl shadow-xl w-full max-w-lg border border-slate-100 flex flex-col max-h-[90vh] overflow-hidden animate-slideUp">
              ...
              <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-4 flex-1">
                ...
                <BooleanRadio
                  id="srv-active"
                  label="Tampilkan Layanan di Website?"
                  value={formData.isActive}
                  onChange={(value) => setFormData({ ...formData, isActive: value })}
                  description="Pilih Ya jika layanan ini boleh tampil di website publik."
                />
