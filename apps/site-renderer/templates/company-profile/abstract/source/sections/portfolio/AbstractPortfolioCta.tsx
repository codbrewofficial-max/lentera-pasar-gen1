...
export function AbstractPortfolioCta({
  title = "Ingin Brand Anda Menjadi Karya Seni Selanjutnya?",
  description = "Kami selalu bersemangat mencari mitra baru yang berani mendobrak kenyamanan visual pasar. Mari buat website, branding, atau produk digital asimetris yang legendaris bersama.",
  ...
  return (
    <section className="relative bg-[#B283AF] text-black py-20 px-6 border-b-8 border-white overflow-hidden">
      {/* Decorative shifted boxes in background */}
