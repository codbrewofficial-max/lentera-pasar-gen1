...
export function AbstractContactCta({
  ...
  description = "Pintu galeri fisik kami selalu terbuka bagi siapa saja yang ingin mencurahkan ide sembari meneguk kopi. Sila buat janji temu atau langsung kunjungi koordinat peta kami.",
  ctaLabel = "PELAJARI METODOLOGI KAMI",
  ctaUrl = "/about"
}: AbstractContactCtaProps) {
  return (
    <section className="relative bg-[#649FF6] text-black py-20 px-6 border-b-8 border-white overflow-hidden">
      {/* Decorative background shapes */}
      <div className="absolute right-0 bottom-0 w-80 h-80 bg-[#B283AF] -mr-20 -mb-20 transform -rotate-12 opacity-80" />
      <div className="absolute left-1/3 top-0 w-1 bg-black h-full transform skew-x-6 opacity-10" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-4 flex justify-start lg:justify-end">
            <Link href={ctaUrl} className="group relative inline-block w-full sm:w-auto">
              ...
              <button className="relative w-full bg-[#F56B71] text-black border-2 border-black font-mono font-bold text-xs tracking-widest py-5 px-8 flex items-center justify-center gap-3 hover:bg-black hover:text-white transition-colors">
