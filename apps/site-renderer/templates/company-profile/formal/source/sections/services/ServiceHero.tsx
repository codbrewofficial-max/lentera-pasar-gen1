...
export const ServiceHero: React.FC<ServiceHeroProps> = ({
  title = "Layanan Profesional untuk Kebutuhan Bisnis",
  subtitle = "Pilih layanan yang paling sesuai dengan kebutuhan pelanggan Anda.",
  badge = "Layanan Kami",
  imageUrl,
}) => {
  return (
    <section id="services-hero" className="bg-slate-900 text-white py-16 md:py-24 relative overflow-hidden">
      {imageUrl && (
