        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className={`${project.imageUrl ? "lg:col-span-7" : "lg:col-span-12"} space-y-8`}>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-xs font-semibold text-slate-950 uppercase tracking-wider font-mono">
                Deskripsi Proyek
              </div>
              <RichHtml
            ...
            {/* {project.challenge && (
              <div className="space-y-3">
                <div className="flex items-center gap-2 text-xs font-semibold text-[#8A6D3B] uppercase tracking-wider font-mono">
                  <HelpCircle className="w-4 h-4" />
                  Tantangan
                </div>
                <p className="text-sm md:text-base text-slate-600 font-light leading-relaxed bg-slate-50 p-5 rounded-none border border-slate-100">
                  {project.challenge}
                </p>
              </div>
            )} */}
            ...
            {/* {project.solution && (
              <div className="space-y-3">
                <div className="flex items-center gap-2 text-xs font-semibold text-[#1E3A5F] uppercase tracking-wider font-mono">
            ...
            {/* {project.result && (
              <div className="space-y-3">
                ...
                <p className="text-sm md:text-base text-emerald-900 font-medium leading-relaxed bg-emerald-50 p-5 rounded-none border border-emerald-100">
                  {project.result}
                </p>
              </div>
            )} */}
