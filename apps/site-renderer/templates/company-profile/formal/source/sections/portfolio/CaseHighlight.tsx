  ...
  return (
    <section id="portfolio-case-highlight" className="py-16 md:py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center bg-white border border-slate-100 rounded-none shadow-sm overflow-hidden">
          ...
          <div className="p-8 md:p-10">
            ...
            <p className="text-sm text-slate-600 font-light leading-relaxed mb-8">{stripHtmlToText(project.description, 140)}</p>
