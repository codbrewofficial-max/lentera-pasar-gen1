  ...
  return (
    <section id="contact-maps" className="py-12 md:py-16 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-white p-2 border border-slate-200 rounded-lg shadow-md overflow-hidden">
          <div className="aspect-[16/9] w-full min-h-[300px] md:min-h-[450px] relative rounded bg-slate-100 overflow-hidden">
        ...
        <div className="mt-6 flex flex-col sm:flex-row items-center justify-between bg-white px-6 py-4 rounded border border-slate-150 gap-4">
          <div className="flex items-center space-x-3">
            <MapPin className="w-5 h-5 text-[#649FF6] flex-shrink-0" />
            <span className="text-xs md:text-sm text-slate-600 font-light leading-snug">{company.contact.address}</span>
          </div>
          <a href={mapsHref} target="_blank" rel="noopener noreferrer" className="text-xs font-mono font-semibold text-[#649FF6] hover:underline uppercase tracking-wider inline-flex items-center space-x-1"><Globe className="w-4 h-4" /><span>Buka Google Maps</span></a>
        </div>
      </div>
    </section>
  );
