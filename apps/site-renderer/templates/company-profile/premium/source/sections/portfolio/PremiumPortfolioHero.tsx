...
export function PremiumPortfolioHero({
  ...
  return imageUrl ? (
    <section id="premium-portfolio-hero" className="relative py-24 md:py-32 overflow-hidden text-center text-white">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 space-y-6">
        <span className="text-[10px] font-bold tracking-[0.3em] text-[#B283AF] uppercase block">{badge || 'GALLERY SHOWCASE'}</span>
