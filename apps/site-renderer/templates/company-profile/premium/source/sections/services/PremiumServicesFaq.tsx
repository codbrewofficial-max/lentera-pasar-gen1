...
interface PremiumServicesFaqProps {
  title?: string;
  description?: string;
  faqs?: FaqItem[];
}

export function PremiumServicesFaq({
  title = "Pertanyaan Umum Layanan",
  description = "Temukan jawaban cepat seputar tata cara kerja, penentuan fee perencanaan, pengawasan lapangan, dan kesiapan pengerjaan proyek di luar wilayah.",
  faqs = defaultFaqs
}: PremiumServicesFaqProps) {
  ...
  return (
    <section id="premium-services-faq" className="py-24 md:py-32 bg-[#FAF9F6] text-[#121212]">
      <div className="max-w-4xl mx-auto px-6">
        {/* Header Block */}
        <div className="text-center space-y-4 mb-20">
          <span className="text-[10px] font-bold tracking-[0.3em] text-[#B283AF] uppercase block">JAWABAN DETAIL</span>
