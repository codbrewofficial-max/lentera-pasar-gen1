...
export interface CasualArticleCtaProps {
  title?: string;
  description?: string;
  ctaLabel?: string;
  ctaUrl?: string;
...
export function CasualArticleCta({
  title = 'Suka Gaya Edukasi Kami? Yuk, Kolaborasi Nyata!',
  description = 'Artikel di atas membuktikan bahwa kami mengerti betul seluk beluk kebutuhan tumbuh kembang UMKM lokal. Jangan simpan ide hebatmu sendiri, mari kita wujudkan bareng dalam desain nyata.',
  ctaLabel = 'Mulai Obrolan Santai',
  ctaUrl = 'https://wa.me/628123456789',
  imageUrl,
}: CasualArticleCtaProps) {
  return (
    <section id="CasualArticleCta" className="py-16 bg-white relative overflow-hidden">
      {/* Decorative Blob */}
...
<div className="max-w-2xl mx-auto space-y-5">
            <div className="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-white text-gray-800 text-[10px] font-extrabold uppercase tracking-wider shadow-sm">
              ...
              <span>MARI NAIK KELAS BARENG</span>
            </div>
