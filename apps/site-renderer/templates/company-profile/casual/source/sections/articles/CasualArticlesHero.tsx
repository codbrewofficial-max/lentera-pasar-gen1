...
export function CasualArticlesHero({
  ...
  return (
    <section id="CasualArticlesHero" className="relative py-16 md:py-24 bg-gradient-to-b from-[#649FF6]/10 via-[#B283AF]/5 to-white overflow-hidden text-center">
      ...
      <div className="absolute bottom-10 left-1/4 text-xl select-none">✏️</div>
      <div className="absolute bottom-12 right-1/4 text-xl select-none">🚀</div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-6">
        <div className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full bg-[#649FF6]/15 text-[#649FF6] text-xs font-bold tracking-wide uppercase">
          <Newspaper className="w-4 h-4 text-[#649FF6]" />
          <span>KABAR & WAWASAN STUDIO</span>
        </div>
        ...
        <div className="flex justify-center gap-1.5 pt-4">
          <div className="w-12 h-2 rounded-full bg-[#B283AF]" />
          <div className="w-4 h-2 rounded-full bg-[#F56B71]" />
          <div className="w-4 h-2 rounded-full bg-[#649FF6]" />
        </div>
      </div>
    </section>
  );
